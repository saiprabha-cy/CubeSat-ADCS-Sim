...
#include "adcs_full_loop_codegen.h"    /* Model header file */
...
void rt_OneStep(void)
{
  ...
  /* Check for overrun */
  if (OverrunFlag) {
    rtmSetErrorStatus(adcs_full_loop_codegen_M, "Overrun");
    return;
  }
...
int_T main(int_T argc, const char *argv[])
{
  ...
  fflush((NULL));
  while (rtmGetErrorStatus(adcs_full_loop_codegen_M) == (NULL)) {
